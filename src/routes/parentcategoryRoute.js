...
const { createparentcategory, getfrontendcategory, updatecategory, deletecategory } = require("../controller/parentcategorycontroller.js")
...
router.get('/getall', getfrontendcategory)
